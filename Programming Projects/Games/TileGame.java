...
public class TileGame extends World<Tile>
{
    ...
    public boolean locationClicked(Location loc)
    {
        ...
        { 
            ...
            {
                /*
                 *  Note: the first tile of a pair has been clicked on.
            ...
            {            
                ...
                setMessage("Click on first tile");
                // ... set first to true
                first = true;
                clicks++;
            }                  
        }
        ArrayList<Location> tiles = gr.getOccupiedLocations();
        for (Location loca : tiles) {
            if (gr.get(loca) != null) {
                done = done && false;
            } else {
                done = done && true;
