...
public class PigGUI implements ActionListener
{
    ...
    private void createAndShowGUI()
    {
        ...
        JLabel pig = new JLabel(createIcon("pig.jpg", PIG_SIZE));
        topPanel.add(pig);
        topPanel.add(Box.createHorizontalStrut(COMPONENT_SPACING));
        JLabel pigLabel = new JLabel("PIG OUT!");
        Font labelFont = new Font(Font.SANS_SERIF, Font.BOLD,PIGOUT_FONT );
        ...
        setScore(1,0);
        setScore(2,0);
        labelFont = new Font(Font.SANS_SERIF, Font.BOLD, LABEL_FONT_SIZE);
