 ...
 * @version 06.17.2021 
 */
public class HallCarpetLayer3_8Tester implements Directions
{
    /**
    ...
    {    
        ...
        World.readWorld(pathMac, "fig3-9.kwld");    // Use for Mac
        ...
        /* Creates a robot */
        HallCarpetLayer3_8 karel = new HallCarpetLayer3_8(9, 2, South, infinity);
