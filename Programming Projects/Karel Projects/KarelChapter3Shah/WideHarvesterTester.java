 ...
 * @version 06.16.2021
 */
public class WideHarvesterTester implements Directions
{
    /**
    ...
    {    
        ...
        World.readWorld(pathMac, "fig3-3a.kwld");    // Use for Mac
        ...
        /* Creates a robot */
        FieldHarvester karel = new WideHarvester(2, 2, East, 0);
