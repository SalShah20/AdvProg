 ...
 * @version 06.22.2021 
 */
public class MazeWalker6_16Tester implements Directions
{
    /**
    ...
    {    
        ...
        World.readWorld(pathMac, "fig6-26test.kwld");    // Use for Mac
        ...
        /* Creates a robot */
        MazeWalker6_16 karel = new MazeWalker6_16(1, 1, East, 0, Color.CYAN);
